...
暗号 op 実装: **Rust + WASM opaque handle** に移行済 — [rust-crypto-stage1.md](./rust-crypto-stage1.md) (純関数) / [rust-crypto-opaque-handle.md](./rust-crypto-opaque-handle.md) (handle pattern)
