...
import {
  ...
  iapVerifyApple,
  iapVerifyGoogle,
} from "/lib/vault-client.js?v=2ce82509";
import { enableEmergencyPad } from "/lib/vault-client.js?v=2ce82509";
import {
  generatePassword,
  passwordStrength,
  isPasskeySupported,
...
async function removeAuthorizedDevice(id) {
  ...
  const { removeCredentialFromEnvelopeUI } = await import("/lib/vault-client.js?v=2ce82509");
...
function startBalancePolling(goal = null) {
  ...
  try {
    import("/lib/vault-client.js?v=2ce82509").then(({ invalidateBalanceCache }) => {
...
document.getElementById("admin-audit-refresh-btn")?.addEventListener("click", async () => {
  ...
  try {
    ...
    const { currentSigningPrivateKeyRaw } = await import("/lib/vault-client.js?v=2ce82509");
    const adminPrivKeyRaw = await currentSigningPrivateKeyRaw();
...
async function _renderAdminNetPolicy() {
  ...
  try {
    ...
    if (!info?.admin) {
      try {
        const { corpInfoUI } = await import("/lib/vault-client.js?v=2ce82509");
